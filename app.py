...
def load_model():
    try:
        ...
        st.error("Model file 'model.onnx' not found. Please ensure the model is in the same directory.")
        return None
...
def main():
    ...
    if uploaded_file is not None:
        ...
        with st.spinner('Processing image...'):
            ...
            prediction = model.run([output_name], {input_name: processed_image})[0]
